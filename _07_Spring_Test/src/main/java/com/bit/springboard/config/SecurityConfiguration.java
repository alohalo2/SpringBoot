...
@Configuration
// @EnableWebSecurity:  SpringSecurity와 FilterChanin을 구성하기 위한 어노테이션
@EnableWebSecurity
...
public class SecurityConfiguration {
    ...
    // Spring Security의 FilterChain을 구성
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                // csrf공격에 대한 방지
                // csrf(Cross Site Request Forgery): 사이트간 위조 요청을 하는 공격
                //                                   정상적인 사용자가 의도치 않게 위조 요청을 보낼 수 있어서 꺼두면
                ...
                .authorizeHttpRequests((authorizeRequests) -> {
                    ...
                    // boards의 모든 하위 요청은 ROLE_USER, ROLE_ADMIM만 접근할 수 있도록 설정
                ...
                .oauth2Login((oauth2Login) -> {
                    ...
                    // 커스터마이징 하려면 DefaultOAuth2UserService 클래스를 상속받아서
