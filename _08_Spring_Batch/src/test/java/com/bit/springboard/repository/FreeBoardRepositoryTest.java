...
@DataJpaTest
// @AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.NONE)
//      : @DataJpaTest 어노테이션은 임베디드 데이터베이스(H2)를 사용하도록 설정되는데
//         실제 어플리케이션 사용하는 DataSource 이용하여 테스트를 진행하도록 설정
...
public class FreeBoardRepositoryTest {
    ...
    void findByIdTest() throws Exception {
        ...
        FreeBoard findByIdFreeBoard = freeBoardRepository.findById(1L)
...
//        Assertions.assertEquals("제목1", findByIdFreeBoard.getTitle());
