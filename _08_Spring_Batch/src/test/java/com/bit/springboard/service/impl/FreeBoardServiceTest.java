...
public class FreeBoardServiceTest {
    // Mockito 클래스를 이용해서 가짜 객체를 생성하고 의존성을 주입
    ...
    // @BeforeEach: 각각의 테스트 코드가 실행되기 전에 실행할 코드 지정
    @BeforeEach
    public void setUpTest() {
        freeService = new FreeServiceImpl(freeMapper, fileUtils, freeBoardRepository, memberRepository, freeBoardFileRepository);
    }
    ...
    void findByIdTest() throws Exception {
        ...
        FreeBoard board = FreeBoard.builder()
                ...
                .content("제곧내")
                .cnt(2)
                .regdate(LocalDateTime.parse("2024-08-23T17:34:38.679867"))
                .moddate(LocalDateTime.parse("2024-08-23T17:34:38.679867"))
        ...
        // verify 메소드를 통해 freeBoardRepository의 searchOne이 한 번 호출됐는지 검증
