...
public class BoardController {
    ...
    public ModelAndView freeListView(@RequestParam Map<String, String> searchMap, Criteria cri) {
        ...
        mav.setViewName("boards/free-list");
...
//        ModelAndView mav = new ModelAndView();
//
//        mav.setViewName("boards/free-detail");
//
//        return mav;
//    }
...
//    }
    ...
    @GetMapping("/post")
    public ModelAndView postView(HttpSession session, HttpServletResponse response) {
        ModelAndView mav = new ModelAndView();
    ...
    public ResponseEntity<?> post(BoardDto boardDto, MultipartFile[] uploadFiles){
        ...
        try {
            ...
            System.out.println(returnBoardDto);
    ...
    public ModelAndView boardDetail(@PathVariable("id") int id,
        ...
        if(type.equals("free")) {
            ...
            boardService = applicationContext.getBean("noticeServiceImpl", BoardService.class);
            mav.setViewName("boards/notice-detail");
        }
    ...
    @GetMapping("/cnt/{id}")
    public void updateBoardCnt(@PathVariable("id") int id, @RequestParam("type") String type, HttpServletResponse response) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> remove(@PathVariable("id") int id, @RequestParam("type") String type) {
