...
@RestController
@RequestMapping("/apis")
@RequiredArgsConstructor // @RequiredArgsConstructor : 생성자 주입 어노테이션
public class ApiController {
    ...
    public ResponseEntity<?> save(
            // @Parameter: API를 호출할 때 보내주는 파라미터에 대한 설명 추가
